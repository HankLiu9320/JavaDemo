...
public class DownloadBuffaloLog {
    public static void main(String[] args) {
        downloadIdeLog();
    }

    public static void downloadIdeLog() {
        String baseUrl = "http://pre.dp.jd.com/buffalo/v4/instance/log/downloadLogs.ajax?runLogId=";
        String saveDir = "/Users/liujianjia/3_data/buffalo_logs/";
        ...
        List<String> ids = readIdsFromFile("buffalo-ids.txt");
    ...
    public static List<String> readIdsFromFile(String filePath) {
        ...
        InputStream inputStream = DownloadBuffaloLog.class.getClassLoader().getResourceAsStream(filePath);
